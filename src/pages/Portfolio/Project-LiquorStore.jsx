...
<div className="w-9/12  mx-auto flex justify-center">
                            ...
                            <div class="h-96">
                                ...
                                <div class="rounded-3xl">
                                    <div class="rounded-md list-none  text-center mt-1 ring-4 ring-gray-900 bg-gray-900">
                                        <li class="py-11 rounded-2xl order-2 border-gray-800 bg-indigo-900 hover:bg-gray-900 ring-2 ring-gray-900 mb-4 cursor-pointer"><a href="https://github.com/gkozlowskidesign/React-CindysWineAndSpirits" class="list-none text-xl font-bold text-white hover:text-indigo-600">Repository</a></li>
    ...
    <div class="container mx-auto px-2 pt-10">
        ...
        <div class="mt-2">
            ...
            <br></br>
                <img className="h-50 w-full  bg-gray-800 rounded-xl ring-4 ring-gray-800" src="https://github.com/gkozlowskidesign/React-Portfolio/blob/main/src/assets/Desktop%20-%20Mockup%20-%20LiquorStore.png?raw=true" alt="" />
       ...
       <br></br>
                <img class="h-50 w-full bg-gray-800 rounded-lg object-cover  ring-4 ring-gray-800" src="https://github.com/gkozlowskidesign/React-Portfolio/blob/main/src/assets/Phone%20-%20Mockup%20-%20LiquorStore.png?raw=true" alt="" />
